...
public class CarritoController {
    private final CarritoAñadirView carritoView;
    private final ProductoController productoController;
    private final Carrito carrito;
    private final CarritoDAO carritoDAO;

    public CarritoController(CarritoAñadirView carritoView, ProductoController productoController, CarritoDAO carritoDAO) {
